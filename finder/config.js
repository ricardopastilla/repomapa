...
const config = {
  ...
  accessToken:
    'pk.eyJ1IjoicGFzdGlsbGFteCIsImEiOiJjbDhoM2hneHowdTE1M29xeGwyNGEwa2Y1In0.KNCloJLO4XmOoEVhZUjuzg',
  CSV: './ubicaciones-pres.csv',
  center: [-102, 24],
  zoom: 4.5,
  title: 'Mapa de Cuidados de México',
  description:
    'Morbi sodales ut risus sit amet hendrerit. Integer nec erat accumsan, dignissim tortor quis, facilisis lectus. Donec placerat venenatis turpis a condimentum. Phasellus in mi dignissim, imperdiet leo vitae, pharetra lacus. Cras eget sollicitudin lectus. Vestibulum hendrerit, lectus vitae convallis pellentesque, tortor tellus interdum lacus, sit amet molestie lacus odio sed sem. ',
  ...
  filters: [
    ...
    },
   {
    ...
    
     {
      ...
      listItems: [
          'Acceso sin derechohabiencia', 
          'Acceso con derechohabiencia',], // Case sensitive - must match spreadsheet entry; This will take up to six inputs but is best used with a maximum of three;
    },
  ],
};
